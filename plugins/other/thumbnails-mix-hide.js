...
window.nova_plugins.push({
   ...
   'desc:id': '[Mix] menawarkan untuk menonton ulang apa yang telah dilihat',
   'desc:es': '[Mix] ofrece volver a ver lo que ya vio',
   'desc:pt': '[Mix] se oferece para rever o que já viu',
   'desc:it': '[Mix] si offre di rivedere ciò che ha già visto',
