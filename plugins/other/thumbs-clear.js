window.nova_plugins.push({
   ...
   options: {
      thumbnails_clear_preview_timestamps: {
         ...
         options: [
            { label: 'start', value: 'hq1', 'label:zh': '开始', 'label:ja': '始まり', 'label:es': 'comienzo' }, // often shows intro
            { label: 'middle', value: 'hq2', selected: true, 'label:zh': '中间', 'label:ja': '真ん中', 'label:es': 'medio' },
            { label: 'end', value: 'hq3', 'label:zh': '结尾', 'label:ja': '終わり', 'label:es': 'fin' }
         ],
      },
